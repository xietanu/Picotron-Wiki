# sub(lhs, rhs, [dest], [read_start], [write_start], [group_size], [read_increment], [write_increment], [group_count]): written

## Overview
Subtracts elements on the right hand side from elements on the left hand side.
